...
export function Header({ onToggleSidebar }: HeaderProps) {
  ...
  return <header className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#38a3a5] rounded-full flex items-center justify-center text-white font-semibold text-sm">
              {loading ? 'P' : getUserInitials()}
            </div>
